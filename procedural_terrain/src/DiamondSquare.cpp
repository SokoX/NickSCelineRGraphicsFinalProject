...
// Constructor 
DiamondSquare::DiamondSquare(std::string name, int n){
...
void saveHelper(std::string modeName, std::string terrainName, std::vector<uint8_t> pixelData, unsigned int m)
{
...
void DiamondSquare::save(bool mode)
{
    ...
    { // save color map
        saveHelper("color_map", terrainName, colorData, max);
    }
};
